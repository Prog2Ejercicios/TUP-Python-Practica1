...
strings_concatenados = variable_01 + str(variable_02) + variable_03 + str(variable_02) + variable_04 + " Se llama " + variable_05
...
strings_concatenados = f"{variable_01}{str(variable_02)}{variable_03}{str(variable_04)}"
