...
# COMPLETAR - INICIO
string_concatenados = str (variable_01)+ str (variable_02) + str (variable_03)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
string_concatenados = "!Mama" "estoy concatenando" "string"
...
# COMPLETAR - INICIO
string_concatenados = variable_01 + str (variable_02) +  variable_03
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
string_concatenados = variable_01 + format( variable_02) + variable_03 +variable_04 + variable_05
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
string_concatenados = f"{variable_01}  {variable_02}  {variable_03}  {variable_04}"
# COMPLETAR - FIN
