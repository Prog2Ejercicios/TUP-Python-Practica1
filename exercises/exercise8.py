...
mario = ["cafetera", "TV 50 pulgadas", "mouse gamer"]
ezequiel = ["ipad", "ipod", "iphone"]
pablo= ["Reproductor de CD", "Videograbadora"]

Compras = {
    "Mario Pedernera":mario,
    "Ezequiel Castello":ezequiel,
    "Pablo Piristrelli":pablo
}
